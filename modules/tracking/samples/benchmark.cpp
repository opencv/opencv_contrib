...
/*
 * TODO:
 * how to allow to select initial frame?: pass it on cmdline --> do normalization ala Kalal's assessment protocol for TLD
 *
 * FIXME:
 */
...
static void help()
{
  cout << "\nThis example shows the functionality of \"Long-term optical tracking API\""
       ...
       "Call:\n"
       "./tracker <video_name> <ground_truth> <algorithm1> <algorithm2> ...\n"
       << endl;
