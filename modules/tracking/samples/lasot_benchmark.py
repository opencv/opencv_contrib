            ...
            for number_of_the_frame, image in enumerate(video_sequence):
                ...
                if args.visualization:
                    cv.rectangle(frame, (int(new_coords[0]), int(
                                    new_coords[2])), (int(new_coords[1]), int(
                                        new_coords[3])), (200, 0, 0))
                    cv.imshow("Tracking", frame)
                    cv.waitKey(1)

                iou_values.append(get_iou(new_coords, gt_coords))
                pr_values.append(get_pr(new_coords, gt_coords))
                n_pr_values.append(get_norm_pr(
