...
# for each metric
# As input for these methods are using lists, generated by 'calc_coords' method.
# Respectively: 
        ...
        for video_name in list_of_videos:
            ...
            for number_of_the_frame, image in enumerate(video_sequence):
                ...
                if gt_bb != (0, 0, 0, 0):
                    ...
                    #    new_coords.values())
                    #gt_xmin, gt_xmax, gt_ymin, gt_ymax, gt_cx, gt_cy = list(
                    #    gt_coords.values())

                    if args.visualization:
                        cv.rectangle(frame, (int(new_coords[0]), int(new_coords[2])), (
                            int(new_coords[1]), int(new_coords[3])), (200, 0, 0))
