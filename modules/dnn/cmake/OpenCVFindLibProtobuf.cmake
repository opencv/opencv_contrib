...
if(NOT BUILD_LIBPROTOBUF_FROM_SOURCES AND PROTOBUF_FOUND AND EXISTS ${PROTOBUF_PROTOC_EXECUTABLE})
  ...
  set(PROTOBUF_SRCS ${CMAKE_CURRENT_SOURCE_DIR}/src/caffe/compiled/caffe.pb.cc)
  set(PROTOBUF_HDRS ${CMAKE_CURRENT_SOURCE_DIR}/src/caffe/compiled/caffe.pb.h)
  add_definitions(-DHAVE_PROTOBUF=1)
  include_directories("${CMAKE_CURRENT_SOURCE_DIR}/src/caffe/compiled/")
