...
class NormalizeBBoxParameter : public ::google::protobuf::Message {
 public:
  ...
  NormalizeBBoxParameter* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
 ...
 private:
  ...
  void InitAsDefaultInstance();
  static NormalizeBBoxParameter* default_instance_;
};
// -------------------------------------------------------------------
...
class PriorBoxParameter : public ::google::protobuf::Message {
 public:
  ...
  inline float min_size() const;
  inline void set_min_size(float value);
  ...
  inline void set_max_size(float value);
...
class LayerParameter : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_normalize_bbox_param() const;
  inline void clear_normalize_bbox_param();
  static const int kNormalizeBboxParamFieldNumber = 139;
  inline const ::caffe::NormalizeBBoxParameter& normalize_bbox_param() const;
  inline ::caffe::NormalizeBBoxParameter* mutable_normalize_bbox_param();
  inline ::caffe::NormalizeBBoxParameter* release_normalize_bbox_param();
  inline void set_allocated_normalize_bbox_param(::caffe::NormalizeBBoxParameter* normalize_bbox_param);
...
inline const ::caffe::NormalizeBBoxParameter& LayerParameter::normalize_bbox_param() const {
  return normalize_bbox_param_ != NULL ? *normalize_bbox_param_ : *default_instance_->normalize_bbox_param_;
}
inline ::caffe::NormalizeBBoxParameter* LayerParameter::mutable_normalize_bbox_param() {
  set_has_normalize_bbox_param();
  if (normalize_bbox_param_ == NULL) normalize_bbox_param_ = new ::caffe::NormalizeBBoxParameter;
