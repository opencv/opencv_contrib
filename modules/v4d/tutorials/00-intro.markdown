...
* [My OpenCV 4.x fork](https://github.com/kallaballa/opencv/tree/GCV) instead of the official with improvements for V4D including **WebAssembly support**
