...
//! @{
	...
	public:
        ...
        /**
        @brief Compute quality score per channel, see specific algorithm for interpreting result scores
        ...
        */
        ...
        /** @brief Returns output quality maps images that were generated during computation, if supported by the algorithm  */
    ...
    protected:
        ...
        std::vector<quality::detail::quality_map_type> _qualityMaps;
