...
class Ximgproc_LSD_ADV: public LSDBase
{
public:
    Ximgproc_LSD_ADV() { }
protected:
...
class Ximgproc_LSD_STD: public LSDBase
{
public:
    Ximgproc_LSD_STD() { }
protected:
...
class Ximgproc_LSD_NONE: public LSDBase
{
public:
    Ximgproc_LSD_NONE() { }
protected:
...
class Ximgproc_LSD_Common : public LSDBase
{
public:
    Ximgproc_LSD_Common() { }
protected:
...
TEST_F(Ximgproc_LSD_ADV, whiteNoise)
{
...
TEST_F(Ximgproc_LSD_ADV, constColor)
{
    for (int i = 0; i < EPOCHS; ++i)
    {
...
TEST_F(Ximgproc_LSD_ADV, rotatedRect)
{
    for (int i = 0; i < EPOCHS; ++i)
    {
...
TEST_F(Ximgproc_LSD_STD, whiteNoise)
{
    for (int i = 0; i < EPOCHS; ++i)
    {
        GenerateWhiteNoise(test_image);
...
TEST_F(Ximgproc_LSD_STD, constColor)
{
    for (int i = 0; i < EPOCHS; ++i)
    {
        GenerateConstColor(test_image);
...
TEST_F(Ximgproc_LSD_STD, rotatedRect)
{
    for (int i = 0; i < EPOCHS; ++i)
    {
        GenerateRotatedRect(test_image);
...
TEST_F(Ximgproc_LSD_NONE, whiteNoise)
{
    for (int i = 0; i < EPOCHS; ++i)
    {
        GenerateWhiteNoise(test_image);
...
TEST_F(Ximgproc_LSD_NONE, constColor)
{
    for (int i = 0; i < EPOCHS; ++i)
    {
        GenerateConstColor(test_image);
...
TEST_F(Ximgproc_LSD_NONE, lines)
{
    for (int i = 0; i < EPOCHS; ++i)
    {
        const unsigned int numOfLines = 1;
...
TEST_F(Ximgproc_LSD_NONE, rotatedRect)
{
    for (int i = 0; i < EPOCHS; ++i)
    {
        GenerateRotatedRect(test_image);
...
TEST_F(Ximgproc_LSD_Common, supportsVec4iResult)
{
    for (int i = 0; i < EPOCHS; ++i)
    {
        GenerateWhiteNoise(test_image);
...
TEST_F(Ximgproc_LSD_Common, drawSegmentsVec4f)
{
    GenerateConstColor(test_image);
...
TEST_F(Ximgproc_LSD_Common, drawSegmentsVec4i)
{
    GenerateConstColor(test_image);
...
TEST_F(Ximgproc_LSD_Common, compareSegmentsVec4f)
{
    GenerateConstColor(test_image);
    Ptr<LineSegmentDetector> detector = createLineSegmentDetector(LSD_REFINE_STD);
...
TEST_F(Ximgproc_LSD_Common, compareSegmentsVec4i)
{
    GenerateConstColor(test_image);
    Ptr<LineSegmentDetector> detector = createLineSegmentDetector(LSD_REFINE_STD);
...
TEST_F(Ximgproc_LSD_Common, drawSegmentsEmpty)
{
    Ptr<LineSegmentDetector> detector = createLineSegmentDetector(LSD_REFINE_STD);
