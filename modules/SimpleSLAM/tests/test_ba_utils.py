...
def generate_scene(
    ...
    *,
    ...
    # --- ground‑truth camera poses (camera-from-world) ---------------
...
class TestBundleAdjustment(unittest.TestCase):
    def test_two_view_ba(self):
        ...
        self.assertAlmostEqual(e0, 0.0, places=6, msg="Initial reprojection error should be zero when add_noise=False")
    ...
    def test_pose_only_ba(self):
        ...
        self.assertAlmostEqual(e0, 0.0, places=6)
    ...
    def test_local_bundle_adjustment(self):
        wmap, kps = generate_scene(n_frames=10, add_noise=False)  # use noise to actually test BA
        e0 = reproj_rmse(wmap, kps)
...
# todo make noise function, to add noise to the points and poses, look at using scipy to convert quaternions to add matrix
# have 0 noise and test if BA converges to 0 
