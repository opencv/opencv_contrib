...
Point2d back(Point2d point, double fx, double fy, double ux, double uy)
{
...
{   
    ...
    vector<Point2d> undistortedPoints, distortedPoints;
    for (int i = 0; i < input_.rows; i++)
    {
        for (int j = 0; j < input_.cols; j++)
        {
            undistortedPoints.push_back(Point2f(i, j));
        }
    }
