...
float FinderPatternFinder::FPS_MS_VAL = 1.0;
float FinderPatternFinder::FP_COUNT_MIN = 2.0;
float FinderPatternFinder::FP_MS_MIN = 1.0;
float FinderPatternFinder::FP_RIGHT_ANGLE = 0.342;
float FinderPatternFinder::FP_SMALL_ANGLE1 = 0.8191;
float FinderPatternFinder::FP_SMALL_ANGLE2 = 0.5736;
